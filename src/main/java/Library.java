...
public class Library {
    ...
    public EncryptionResponse Encryption() throws Exception {
        int tagSize = 96;
       ...
       // System.out.println(off);
        ...
        response.Cipher = DatatypeConverter.printHexBinary(ct);
        response.Tag = DatatypeConverter.printHexBinary(tag);
